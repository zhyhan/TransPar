...
def main(args: argparse.Namespace):
    ...
    optimizer = SGD(classifier.get_parameters(), args.lr, momentum=args.momentum, weight_decay=args.wd, nesterov=False)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    for i in range(args.iters_per_epoch):
        ...
        LTH(classifier.backbone, keep_ratio = keep_ratio)
        LTH(classifier.bottleneck, keep_ratio = keep_ratio)
        LTH(classifier.head, keep_ratio = keep_ratio)
        LTH(classifier.adv_head, keep_ratio = 1. - keep_ratio)
